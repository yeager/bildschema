...
- 🌍 **Translated** — full Swedish translation via [Transifex](https://app.transifex.com/danielnylander/bildschema)
...
Translate Bildschema on [Transifex](https://app.transifex.com/danielnylander/bildschema).
